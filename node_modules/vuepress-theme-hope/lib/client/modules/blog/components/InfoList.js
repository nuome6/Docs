            ...
            activeType.value === "article"
                ? h("div", { class: "vp-star-article-wrapper" }, [
                    ...
                    stars.value.items.length
                        ? h("ul", { class: "vp-star-articles" }, stars.value.items.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "vp-star-article" }, h(RouteLink, { to: path }, () => info[PageInfo.title])))))
                        : h("div", { class: "vp-star-article-empty" }, locale.value.empty.replace("$text", locale.value.star)),
                ])
                : activeType.value === "category"
                    ? h("div", { class: "vp-category-wrapper" }, [
                        categoryNumber.value
                            ...
                            : h("div", { class: "vp-category-empty" }, locale.value.empty.replace("$text", locale.value.category)),
                    ])
                    : activeType.value === "tag"
                        ? h("div", { class: "vp-tag-wrapper" }, [
                            tagNumber.value
                                ...
                                : h("div", { class: "vp-tag-empty" }, locale.value.empty.replace("$text", locale.value.tag)),
                        ])
