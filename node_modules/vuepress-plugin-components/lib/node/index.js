...
`)},Be=(e,a=!0)=>n=>(a&&ze(e),n.env.isDebug&&r.info("Options:",e),K(n,{id:"hope"}),{name:F,define:xe(e),extendsBundlerOptions:(t,s)=>{e.components?.includes("ArtPlayer")&&j(t,s,"artplayer"),e.components?.includes("FontIcon")&&f(t,s,"iconify-icon"),e.components?.includes("VidStack")&&f(t,s,/^media-/),H(t,s,["@vuepress/helper","vuepress-shared"])},clientConfigFile:t=>Ee(t,e)});export{T as AVAILABLE_SERVICES,c as SHARE_CONFIG,Be as componentsPlugin,z as pdfLocaleConfig,x as siteInfoLocaleConfig,E as vidstackLocales};
